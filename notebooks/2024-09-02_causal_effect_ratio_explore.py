...
for dataset_setup in tqdm(ParameterGrid(xp_grid)):
    ...
    delta_mu_of_x_grid.append(mean_causal_effect(dataset.df.mu_1, dataset.df.mu_0))
...
print(
    pd.DataFrame(delta_mu_of_x_grid)
    .describe(percentiles=np.array([1, 10, 25, 50, 60, 65, 70, 75, 90, 99]) / 100)
